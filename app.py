...
content = {
    ...
    "தமிழ்": {
        ...
        "features": [
            ...
            "🛡️ உரிமைகள் பாதுகாப்பு: அரசமைப்பு அறிவுடன் சமர்பிக்கவும்.",
    ...
    "ಕನ್ನಡ": {
        ...
        "features": [
            ...
            "🛡️ ಹಕ್ಕು ರಕ್ಷಣೆ: ಸಂವಿಧಾನದ ಜ್ಞಾನದಿಂದ ಸಜ್ಜಾಗಿರಿ.",
    ...
    "മലയാളം": {
        ...
        "features": [
            ...
            "🛡️ അവകാശ സംരക്ഷണം: ഭരണഘടനാപരമായ അറിവ് നൽകുന്നു.",
    ...
    "اردو": {
        ...
        "features": [
            ...
            "🛡️ حقوق کا دفاع: آئینی علم سے خود کو لیس کریں۔",
